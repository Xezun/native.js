...
module.exports = require("./native.js").extend(function() {
    ...
    function NativeEventService(native) {
        ...
        function _documentElementDidSelect(documentName, elementName, index, callback) {
            ...
            return native.core.perform(Native.Method.eventService.documentElementDidSelect, documentName, elementName, index, callback);
        }
        ...
        function _documentElementWasClicked(documentName, elementName, data, callback) {
            ...
            return native.core.perform(Native.Method.eventService.documentElementWasClicked, documentName, elementName, data, callback);
        }
        ...
        function _track(eventName, parameters) {
            ...
            return native.core.perform(Native.Method.eventService.track, eventName, parameters);
        }
    ...
    let _eventService = new NativeEventService(this);
